from hypothesis import note, strategies as st, given
import pytz
import ecdsa
import os
import random
...
from guzilib.blockchain import VERSION, Blockchain, UserBlockchain, Block, Transaction, MAX_TX_IN_BLOCK
...
from guzilib.crypto import guzi_hash, EMPTY_HASH
from tests.test_utils import NEW_USER_PUB_KEY, NEW_USER_PRIV_KEY, REF_PUB_KEY, REF_PRIV_KEY, KEY_POOL, BIRTHDATE, make_blockchain, random_transaction
...
class TestUserBlockchainPayToUser:
    ...
    def test_transaction_is_correctly_created(self):
        result = self.init()
        expected_tx = Transaction(VERSION, Transaction.PAYMENT, 
...
class TestBlockchainEq:
    ...
    @given(d=st.dates(), 
            me=st.sampled_from(KEY_POOL),
            ref=st.sampled_from(KEY_POOL))
...
class TestBlockchainGetAvailableGuzis:
    ...
    def test_return_all_dates(self):
        ...
        result = blockchain._get_available_guzis()
        expected = [
            ('2011-12-13', 0), ('2011-12-13', 1), ('2011-12-13', 2), ('2011-12-13', 3), ('2011-12-13', 4), 
            ('2011-12-14', 0), ('2011-12-14', 1), ('2011-12-14', 2), ('2011-12-14', 3), ('2011-12-14', 4), 
            ('2011-12-15', 0), ('2011-12-15', 1), ('2011-12-15', 2), ('2011-12-15', 3), ('2011-12-15', 4), 
        ]
    ...
    def test_return_evolving_total(self):
        ...
        expected = [
            ('2011-12-13', 0), ('2011-12-13', 1), ('2011-12-13', 2), ('2011-12-13', 3), ('2011-12-13', 4), 
            ('2011-12-14', 0), ('2011-12-14', 1), ('2011-12-14', 2), ('2011-12-14', 3), ('2011-12-14', 4), ('2011-12-14', 5), 
            ('2011-12-15', 0), ('2011-12-15', 1), ('2011-12-15', 2), ('2011-12-15', 3), ('2011-12-15', 4), ('2011-12-15', 5), ('2011-12-15', 6), 
        ]
...
class TestBlockchainRefuseTransaction:
    ...
    def make_any_transaction(self):
        return Transaction(VERSION, Transaction.PAYMENT, REF_PUB_KEY, 12, tx_date=date(1998, 12, 21).isoformat(), target_user=NEW_USER_PUB_KEY, signature=0x12)
...
class TestBlockAddTransactions:
    ...
    def test_raise_exception_if_too_much_transactions_in_last_block(self):
        ...
        for i in range(MAX_TX_IN_BLOCK):
           block.add_transaction(Transaction(VERSION, Transaction.PAYMENT, NEW_USER_PUB_KEY, i))
